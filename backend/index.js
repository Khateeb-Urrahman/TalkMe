...
try {
  ...
  if (process.env.RAILWAY_PROJECT_ID) {
    ...
    // For local development, use the service account key file if it exists
    try {
      ...
      console.warn('Service account key not found, Firebase Admin features will be disabled');
      console.log('To enable Firebase Admin features, download the service account key from Firebase Console and save it as backend/service-account-key.json');
      // Don't initialize admin if key is missing
  ...
  console.log('Continuing without Firebase Admin features (notifications will be disabled)');
